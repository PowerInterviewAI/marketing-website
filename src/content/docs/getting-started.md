...
1. Download the latest desktop release for your OS from the official releases page.
2. Install and open the application.
3. Create an account or sign in. New users typically receive a trial credit allotment.

## System Requirements

- OS: Windows 10/11, macOS 12+, or a recent Linux distribution
- CPU: Dual-core or better
- RAM: 8 GB minimum
- Webcam and microphone for simulated interviews

## First-Time Setup

1. Launch the app and complete onboarding prompts.
2. Grant camera and microphone permissions when requested.
3. Create your interview profile (name, photo for face-swap, resume/CV).

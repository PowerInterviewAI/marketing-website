...
export default function Seo({ title, description, url, image, noIndex }: SeoProps) {
  useEffect(() => {
    ...
    const resolvedDescription =
      description ||
      'New users get a full 1-hour free trial with Qwen3.6 27B - no rate limits, no interruptions. Privacy-first AI interview coach and meeting note taker - live transcription, AI reply suggestions, mock interview practice, and smart exports for Google Meet, Zoom, Teams, and more.';
